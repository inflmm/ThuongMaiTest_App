...
function initBlogToC() {
    ...
    // Thêm class có css min-height = 0 khi load xong
    document.getElementById('static-toc').classList.add('is-loaded');
    document.getElementById('blog-content').classList.add('is-loaded');
